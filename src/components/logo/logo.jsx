 ...
 */
/**
 * Renders the Chavruta Match logo with responsive design for mobile and desktop.
 * 
 * @component
 * @param {Object} props - Component properties
 * @param {boolean} props.isMobile - Indicates whether the logo is being rendered for a mobile device
 * @returns {React.ReactElement} A logo component with SVG graphic and optional text
 * @description Creates a book-shaped logo with Hebrew and English text, adapting size and layout based on device type
 */
/**
 * Renders the Chavruta Match logo with responsive design for mobile and desktop.
 * 
    ...
    <Box sx={{ 
      ...
      >
        ...
        <text 
          ...
          style="paint-order: stroke fill; stroke: #8B4513; stroke-width: 1px; stroke-linejoin: round;"
        >
          חברותא
        </text>
