...
//     const off = useSelector(state => state.offers.offer)
//     // const [event,setevent] = useState({id:params.id, name:params.name, date:params.date, time:params.time, description:params.description})
//     const offers = useSelector(state => state.offers.offers)
//     const [offer, setOffer] = useState({ personId: param.id, book: "", subject: "", mode: "" });
//     // const newOffer = useSelector(state => state.offers.offers)
//     const getOffers = async () => {
//         dispatch(getOffersByIdThunk(param.id))
//     }
//     const addOffer = async () => {
//         dispatch(AddOfferThunk(offer))
//         ref.current.close()
//     }
//     const deleteoffer = async (code) => {
//         dispatch(DeleteOfferThunk(code))
//     }
//     const updateOffer = async () => {
//         editOffer(offer)
//         dispatch(UpdateOfferThunk({ code: offer.code, request: offer }))
//         ref.current.close()
//     }

//     return <div>
//         <nav>
//             <button className='rightClck' onClick={() => getOffers()}>ההצעות שלי</button>
//             <button className='rightClck' onClick={() => ref.current.showModal()}>הוספת הצעה</button>
//             <button onClick={() => navigate(`/schedule/${param.id}`)}>מערכת שעות</button>
...
//         </div >
//             <label>ת.ז</label><br />
//             <lebel type="password" >{param.id}</lebel><br />
//             <label>ספר:</label><br />
//             <input type="text" placeholder="ספר" onChange={x => setOffer({ ...offer, book: x.target.value })}></input><br />
//             <label>נושא:</label><br />
//             <input type="text" placeholder="נושא" onChange={x => setOffer({ ...offer, subject: x.target.value })}></input><br />
//             <label>אופן הלמידה:</label><br />
//             <input type="text" placeholder="אופן הלמידה" onChange={x => setOffer({ ...offer, mode: x.target.value })}></input><br />
//             {key == true && <button onClick={() => updateOffer()}>עדכון</button>}
//             {key == false && <button onClick={() => addOffer()}>הוספה</button>}
...
//                     <TableRow className="tableRow" component="th" scope="row" onClick={() => editOffer(x)}>
...
//                         <TableCell align="center"><Fab color="error" aria-label="DeleteIcon" onClick={() => deleteoffer(x.code)}>
//                             <DeleteIcon />
//                         </Fab></TableCell>
