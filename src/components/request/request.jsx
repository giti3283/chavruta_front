...
// import { Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, FormControl, IconButton, Input, InputAdornment, InputLabel, Stack, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField } from "@mui/material";
...
//     //הבקשה הנוכחית
//     const req = useSelector(s => s.requests.request)
//     const [key, setKey] = useState(false)
//     const [search, setSearch] = useState("book")
//     const [what, setWhat] = useState("")
//     const [request, setRequest] = useState({ code: req.code, personId: param.id, book: req?.book, subject: req.subject, mode: req.mode,chavrutaCode:req?.chavrutaCode });
...
//         dispatch(AddRequestsThunk(request))
//         setOpen(false)
//     }

//     const deleteRequest = async (c) => {
//         dispatch(DeleteRequestThunk(c))

//     }

//     const updateRequest = async () => {
//         editRequest(request)
//         dispatch(UpdateRequestThunk({ code: request.code, request: request }))
//         setOpen(false)
//     }

//     // const editRequest2 = async (x) => {
//     //     await dispatch(editRequest({...x,personId:x.personId,chavrutaCode:x.chavrutaCode}))
//     // }
//     // const getChavruta = async (code) =>{
//     //     dispatch(GetChavrutaThunk(code))
//     // }
//     return <div>
//         {/* <Paper
//             component="form"
...
//         <InputLabel id="demo-simple-select-label">חפש לפי</InputLabel>
//          <Select
...
//     </Box>
//             <InputBase
//                 onChange={(x) => setWhat(x.target.value)}
//                 sx={{ ml: 1, flex: 1 }}
//                 placeholder="חיפוש"
...
//         </Paper> */}
//         <nav>
//             <Button className='rightClck' onClick={() => getRequest()}>הבקשות שלי</Button>
//             <Button className='rightClck' onClick={() => {setOpen(true); setKey(false)}}>הוספת בקשה</Button>
//             <Button className='rightClck' onClick={() => navigate(`/schedule/${param.id}`)}>מערכת שעות</Button>
//             <Box sx={{ '& > :not(style)': { m: 1 } }} onClick={() => setOpen(true)}>
//                 <Fab color="primary" aria-label="add">
//                     <AddIcon />
//                 </Fab></Box>
//             {/* <label>חפש לפי: </label>
//             <input type="text" id="mySearch" placeholder="🔎 Search.." title="Type in a book" onChange={(x) => setWhat(x.target.value)}></input>
...
//                 <DialogContent>
//                     {/* <DialogContentText>
//                         To add your request, please enter the details here.
//                     </DialogContentText> */}
//                     <TextField required id="outlined-basic" placeholder="Subject" value={request.subject} onChange={x => setRequest({ ...request, subject: x.target.value })}/>
//                     <TextField id="outlined-basic" type="text" placeholder="The book I want to learn" value={request.book} onChange={x => setRequest({ ...request, book: x.target.value })} />
//                     <TextField required id="outlined-basic" placeholder="Mode" value={request.mode} onChange={x => setRequest({ ...request, mode: x.target.value })}/>
//                     </DialogContent>
//                 <DialogActions>
//                     <Stack spacing={2} direction="row">
//                         {key == true && <Button onClick={() => updateRequest()}>Update</Button>}
//                         {key == false && <Button onClick={() => addRequest()}>Add</Button>}
...
//             <label>ספר:</label><br />
//             <input type="text" placeholder="ספר" value={request.book} onChange={x => setRequest({ ...request, book: x.target.value })}></input><br />
//             <label>נושא:</label><br />
//             <input type="text" placeholder="נושא" value={request.subject} onChange={x => setRequest({ ...request, subject: x.target.value })}></input><br />
//             <label>אופן הלמידה:</label><br />
//             <input type="text" placeholder="אופן הלמידה" value={request.mode} onChange={x => setRequest({ ...request, mode: x.target.value })}></input><br />
//             {key == true && <button onClick={() => updateRequest()}>עדכון</button>}
//             {key == false && <button onClick={() => addRequest()}>הוספה</button>}
...
//                     <TableCell align="center">ספר</TableCell>
//                     <TableCell align="center">נושא</TableCell>
//                     <TableCell align="center">אופן הלימוד</TableCell>
//                     <TableCell align="center">מחק</TableCell>
//                     <TableCell align="center">ערוך</TableCell>
//                     <TableCell align="center">להתאמת חברותא</TableCell>
//                 </TableRow>
//             </TableHead>
//             <TableBody>
//                 {requests?.map(x =>
//                     //hidden={search === "book"?!x.book.includes(what):!x.subject.includes(what)}
//                     // ((search == "book" && x.book.includes(what) )||( search == "subject" && x.subject.includes(what))) &&
//                     <TableRow className="tableRow" component="th" scope="row">
//                             <TableCell align="center">{x.code}</TableCell>
//                             <TableCell align="center">{x.book}</TableCell>
//                             <TableCell align="center">{x.subject}</TableCell>
//                             <TableCell align="center">{x.mode}</TableCell>
//                             {/* <TableCell align="center">{x.chavrutaCode}</TableCell> */}

//                             <TableCell align="center"><Fab color="error" aria-label="DeleteIcon" onClick={() => {
//                                 deleteRequest(x.code)
//                                 setKey(false)}}>
//                                 <DeleteIcon />
//                             </Fab></TableCell>
//                             <TableCell align="center"><Fab color="secondary" aria-label="edit" onClick={() => {
//                                 setRequest(x)
//                                 setOpen(true)
//                                 setKey(true)
//                             }}>
//                                 <EditIcon />
//                             </Fab></TableCell>
//                             <TableCell align="center"><Fab color="success" aria-label="HandshakeSharpIcon" onClick={() => navigate(`/chavruta/${x.code}`)}>
//                                 <HandshakeSharpIcon />
//                             </Fab></TableCell>
...
//   // Create theme with purple colors
...
//       code: "Code",
//       search: "Search requests...",
//       searchPlaceholder: "Search by book, subject or method...",
//       filterBy: "Filter by",
//       all: "All",
//       books: "Books",
//       subjects: "Subjects",
...
//       emptyStateMessage: "Add your first learning request to get started",
//       language: "Language",
//       dashboard: "Dashboard",
//       notifications: "Notifications",
//       settings: "Settings",
...
//       bookPlaceholder: "Enter the book you want to learn",
//       subjectPlaceholder: "Enter the subject",
//       modePlaceholder: "Enter your preferred learning method",
//       findMatch: "Find a Match",
//       noMatchesFound: "You don't have any Chavruta matches yet. Create a request to find a learning partner.",
//       noFavoritesFound: "You haven't saved any favorite requests yet."
//     },
//     he: {
//       myRequests: "הבקשות שלי",
//       addRequest: "הוספת בקשה",
...
//       code: "קוד",
//       search: "חיפוש בקשות...",
//       searchPlaceholder: "חיפוש לפי ספר, נושא או שיטה...",
//       filterBy: "סנן לפי",
//       all: "הכל",
//       books: "ספרים",
//       subjects: "נושאים",
...
//       emptyStateMessage: "הוסף את בקשת הלימוד הראשונה שלך כדי להתחיל",
//       language: "שפה",
//       dashboard: "לוח בקרה",
//       notifications: "התראות",
//       settings: "הגדרות",
...
//       back: "חזור",
//       success: "הצלחה!",
//       viewAll: "צפה בכל הבקשות",
//       getStarted: "התחל",
//       requestsFound: "בקשות נמצאו",
//       status: "סטטוס",
//       actions: "פעולות",
//       requiredField: "שדה זה הוא חובה",
//       bookPlaceholder: "הזן את הספר שברצונך ללמוד",
//       subjectPlaceholder: "הזן את הנושא",
//       modePlaceholder: "הזן את שיטת הלימוד המועדפת עליך",
//       findMatch: "מצא התאמה",
//       noMatchesFound: "אין לך עדיין התאמות חברותא. צור בקשה כדי למצוא שותף ללימוד.",
//       noFavoritesFound: "עדיין לא שמרת בקשות מועדפות."
//     }
//   };
...
//                 required
//                 error={!request.book}
//                 helperText={!request.book ? t.requiredField : ""}
//                 InputProps={{
//                   startAdornment: (
//                     <InputAdornment position="start">
//                       <BookIcon color="secondary" />
...
//                 required
//                 error={!request.subject}
//                 helperText={!request.subject ? t.requiredField : ""}
//                 InputProps={{
//                   startAdornment: (
//                     <InputAdornment position="start">
//                       <SubjectIcon color="secondary" />
...
//                 required
//                 error={!request.mode}
//                 helperText={!request.mode ? t.requiredField : ""}
//                 InputProps={{
//                   startAdornment: (
//                     <InputAdornment position="start">
//                       <SchoolIcon color="secondary" />
...
//               {isEditMode ? t.requestUpdated : t.requestAdded}
//             </Typography>
//             <StyledButton
//               variant="contained"
//               color="primary"
...
//           <Step>
//             <StepLabel>{t.book}</StepLabel>
//           </Step>
//           <Step>
//             <StepLabel>{t.subject} & {t.learningMethod}</StepLabel>
//           </Step>
//         </Stepper>
//       </Box>
//     );
...
//           <ListItemIcon>
//             {mode === 'dark' ? <LightModeIcon color="primary" /> : <DarkModeIcon color="primary" />}
//           </ListItemIcon>
...
//           <ListItemIcon>
//             {viewMode === 'table' ? <ViewModuleIcon color="primary" /> : <ViewListIcon color="primary" />}
//           </ListItemIcon>
//           <ListItemText primary={t.viewAs} />
//         </ListItem>
...
//           <Box sx={{ bgcolor: alpha(theme.palette.background.paper, 0.9) }}>
//             <Tabs
//               value={tabValue}
//               onChange={handleTabChange}
//               variant="fullWidth"
...
//                       {sortedRequests.length} {t.requestsFound}
//                     </Typography>
                    
//                     <Chip 
//                       label={filterType !== 'all' ? t[filterType] : t.all}
//                       color="primary"
//                       size="small"
//                       onDelete={filterType !== 'all' ? () => setFilterType('all') : undefined}
//                       sx={{ fontWeight: 'medium' }}
//                     />
//                   </Box>
//                 )}
...
//                           <StyledTableCell align="center" colSpan={3}>{t.actions}</StyledTableCell>
//                         </TableRow>
//                       </TableHead>
//                       <TableBody>
//                         {sortedRequests.map((item, index) => (
...
//                   startIcon={textDirection === 'rtl' ? <ArrowForwardIcon /> : <ArrowBackIcon />}
//                 >
//                   {t.back}
//                 </StyledButton>
//               )}
...
//                   disabled={!request.book}
//                   endIcon={textDirection === 'rtl' ? <ArrowBackIcon /> : <ArrowForwardIcon />}
//                   sx={{ 
//                     background: `linear-gradient(135deg, ${theme.palette.primary.main} 0%, ${theme.palette.primary.dark} 100%)`,
//                   }}
//                 >
